...
-----------------------------
- Revisar y, si procede, filtrar llamadas con duración 0.
- Revisar el tratamiento de usuarios que dieron de baja (churn) para excluir meses posteriores a la baja.
- Realizar pruebas estadísticas (por ejemplo, t-test) para validar diferencias significativas entre planes.
- Evaluar sensibilidad del resultado ante cambios en el factor de conversión y reglas de redondeo.
- Preparar un informe ejecutivo con cifras clave y recomendaciones comerciales.